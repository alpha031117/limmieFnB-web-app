...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6 text-orange-600">Recipe Modification Logs</h1>
                ...
                @foreach ($logs as $log)
                    <tr x-data="{ isOpen: false }">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $log->subject->name ?? 'Deleted Recipe' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        ...
                        >
                            ...
                            @else
                                <span class="text-gray-400 italic">Recipe deleted</span>
                            @endif
                        </td>                        
                    </tr>
                @endforeach
