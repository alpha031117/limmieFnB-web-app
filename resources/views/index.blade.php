...
<html lang="en">
    ...
    <body class="font-sans bg-gray-100">
        ...
        <!-- Hero Section -->
        <div class="bg-gradient-to-b from-orange-300 to-transparent py-32 text-center">
            <div class="container mx-auto px-4">
                <h1 class="text-5xl font-bold text-black mb-10">Discover Delicious Recipes & Food Stories</h1>
                <p class="text-lg text-gray-700 mb-10">Explore our collection of mouthwatering recipes, cooking tips, and food adventures from around the world.</p>
                <div class="flex justify-center gap-8">
                    <a href="/blog" class="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-md text-lg transition-all">
                        Browse Food Blog
                    </a>
                    <a href="/recipes" class="bg-white border border-gray-300 hover:bg-gray-100 text-orange-600 px-8 py-3 rounded-md text-lg transition-all">
                        Browse Recipes
                    </a>
                </div>
            </div>
        ...
        <div class="py-24 text-center">
            <div class="container mx-auto px-4">
                ...
                <p class="text-lg text-gray-700 mb-8">
                    Share your recipes, connect with food enthusiasts, and get inspired by culinary creations from around the world.
                </p>
                <form action="#" method="POST" class="flex justify-center gap-4">
                    <input type="email" placeholder="Enter your email" class="px-4 py-2 border border-gray-300 rounded-md w-64" required>
                    <button type="submit" class="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-md text-lg transition-all">
                        Subscribe
                    </button>
                </form>
                <p class="text-sm text-gray-500 mt-4">
                    By subscribing, you agree to our <a href="#" class="text-orange-600">terms</a> and <a href="#" class="text-orange-600">privacy policy</a>.
                </p>
            </div>
        </div>    
